					...
					<tr>
						<td colspan="2">
							...
							<c:if test="${!empty student.name}">
								<input class="btn btn-warning" type="submit" value="<spring:message text="Edit Student"/>" />
							</c:if> 
						...
						<tr>
							...
							<td>
								...
								<button class="btn btn-warning">
									<a href="${pageContext.request.contextPath}/editStudent/${student.id}" style="color:black">Edit</a>
								</button>&nbsp;
								
								<button class="btn btn-danger">
									<a href="<c:url value='/removeStudent/${student.id}' />" style="color:black">Delete</a>
								</button>
